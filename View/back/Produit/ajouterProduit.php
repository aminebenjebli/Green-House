...
<div id="wrapper">
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">AJOUT PRODUIT</h4>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control" required placeholder="categorie"
                                            ...
                                            foreach ($listCategorie
                                                     as $Categorie) {
                                                ?>
                                                <option value="<?php echo $Categorie['Id_cat'] ?>"><?php echo $Categorie['NomCategorie'] ?></option>
    ...
    <script>
        function verif(event) {
            if (document.getElementById("Nomproduit").value.length < 3) {
                alert("nom produit doit etra > 3");
                event.preventDefault();
                document.getElementById("Nomproduit").focus();
                return false;
            }
            if (document.getElementById("Marque").value.length < 3) {
                alert("marque produit doit etra > 3");
                event.preventDefault();
            ...
            if (isNaN(document.getElementById("Qte_stock").value)) {
                alert("Quantite doit etre un nombre");
                event.preventDefault();

                document.getElementById("Qte_stock").focus();
                return false;
            }
        }
    </script>
