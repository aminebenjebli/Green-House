...
$listCategorie = $CategorieC->affichercategories();
if (isset($_GET['NumProduit'])) {
    $produit = $produitC->recupererproduit($_GET['NumProduit']);
}
if (
    ...
    if (
        ...
        if (strlen($_FILES['img']['tmp_name']) != 0) {
            ...
            move_uploaded_file($_FILES['img']['tmp_name'], 'C:\xampp\htdocs\gestion-produit\View\back\assets\images\produit\\' . $newname);
        } else {
            $newname = $produit['image_prod'];
        }
        ...
        $produitC->modifierproduit($Produit, $_GET['NumProduit']);
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>Nom</label>
                                        <input type="text" class="form-control" required placeholder="nom Produit"
                                               name="Nomproduit" value="<?php echo $produit['Nomproduit'] ?>"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Marque</label>
                                        <input type="text" class="form-control" required placeholder="Marque"
                                               name="Marque" value="<?php echo $produit['Marque'] ?>"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Prix</label>
                                        <input type="text" class="form-control" required placeholder="Prix"
                                               name="Prix" value="<?php echo $produit['Prix'] ?>"/>
                                    </div>
                                    <div class="form-group">
                                        <label>description</label>
                                        <input type="text" class="form-control" required placeholder="description"
                                               name="Prod_desc" value="<?php echo $produit['Prod_desc'] ?>"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Quantite</label>
                                        <input type="text" class="form-control" required placeholder="quantite"
                                               name="Qte_stock" value="<?php echo $produit['Qte_stock'] ?>"/>
                                    </div>

                                    <div class="form-group">
                                        <label>Quantite</label>
                                        <select type="text" class="form-control" required placeholder="categorie"
                                                name="Id_cat">

                                            <?php
                                            foreach ($listCategorie
                                                     as $Categorie) {
                                                ?>
                                                <option <?php if ($produit['Id_cat'] == $Categorie['Id_cat']) echo "selected" ?>
                                                        value="<?php echo $Categorie['Id_cat'] ?>"><?php echo $Categorie['NomCategorie'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
