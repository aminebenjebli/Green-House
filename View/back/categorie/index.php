                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="sub-title font-14">This is an experimental awesome solution for responsive
                                ...
                                <div class="table-rep-plugin">
                                    <div class="table-responsive b-0" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table  table-striped">
                                            ...
                                            <tbody>
                                            <?php
                                            foreach ($listeCategories

                                            as $Categorie) {
                                            ?>
                                            <tr>
                                                <th><?php echo $Categorie['NomCategorie']; ?></th>
                                                <td><img style="width: 30px;height: 30px"
                                                         src="http://localhost:80/gestion-produit/View/back/assets/images/categorie/<?php echo $Categorie['image_cat']; ?>"
                                                         alt=""></td>
                                                <td style="display: flex; justify-content: center">
                                                    <a href="modifiercategorie.php?Id_cat=<?php echo $Categorie['Id_cat']; ?>"
                                                       class="btn btn-tbl-edit">
                                                        <i class="fa fa-edit"
                                                           style="font-size:20px;color:rgb(15, 192, 15)"></i>
                                                    </a>
                                                    <form method="POST"
                                                          action="supprimercategorie.php?Id_cat=<?php echo $Categorie['Id_cat']; ?>"
                                                          onsubmit="return confirm('tu est sure de supprimer cette categorie');">
