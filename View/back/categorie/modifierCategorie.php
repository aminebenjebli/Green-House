...
if (isset($_GET['Id_cat'])) {
    $Categorie = $CategorieC->recuperercategorie($_GET['Id_cat']);
}
if (
    isset($_POST["Id_cat"]) &&
                    ...
                    <div class="col-lg-6">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <form onsubmit="return verif(event)" class="" action="#" method="POST">
                                    <input type="hidden" value="<?PHP echo $_GET['Id_cat']; ?>" name="Id_cat">

                                    <div class="form-group">
                                        <label>Nom</label>
                                        <input type="text" class="form-control" required placeholder="nom categorie"
                                               name="NomCategorie" value="<?php echo $Categorie['NomCategorie']; ?>"
                                               id="NomCategorie"/>
                                    </div>
