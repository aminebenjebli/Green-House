...
if (isset($_GET['id'])) {
    $remise = $remiseC->recupererRemise($_GET['id']);
}
if (
    ...
    if (
        ...
        $remiseC->modifierRemise($remise, $_GET['id']);
...
<div id="wrapper">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="ajouterRemise.php">ajouter Produit</a></li>
                        </ul>
                    </li>
                    <li>
                                ...
                                <form onsubmit="return verif(event)" action="" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" required
                                               name="dateD" id="dateD" value="<?php echo $remise['date_debut'] ?>"/>
                                    </div>
                                    <div class="form-group">
                                        <label>date fin</label>
                                        <input type="date" class="form-control" required
                                               name="dateF" id="dateF" value="<?php echo $remise['date_fin'] ?>"/>
                                    </div>
                                    <div class="form-group">
                                        <label>pourcentage</label>
                                        <input type="number" class="form-control" required placeholder="Pourcentage"
                                               name="Pourcentage" id="Pourcentage"
                                               value="<?php echo $remise['pourcentage'] ?>"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control" required
                                            ...
                                            foreach ($listeProduit
                                                     as $produit) {
                                                ?>
                                                <option <?php if ($remise['NumProduit'] == $produit['NumProduit']) echo 'selected' ?>
                                                        value="<?php echo $produit['NumProduit'] ?>"><?php echo $produit['Nomproduit'] ?></option>
    ...
    <script>
        function verif(event) {
            if (document.getElementById("Pourcentage").value > 100 || document.getElementById("Pourcentage").value < 0) {
                alert("porcentage doit etre entre 0 et 100");
